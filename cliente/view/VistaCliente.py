...
class VistaCliente(QWidget):
    def __init__(self, cliente, elimina_cliente, elimina_callback, parent=None):
        ...
        label_eta = QLabel("Età: {}".format(self.controller.get_eta_cliente()))
        font_eta = label_eta.font()
        font_eta.setPointSize(17)
        label_eta.setFont(font_eta)
        v_layout.addWidget(label_eta)
